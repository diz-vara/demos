...
opt = lapp[[
   ...
   -n, --network  (default 'results_c12/model.net')   path to networkimage.
...
--  Changing existing network: I don't understand this stuff
...
vid = ffmpeg.Video{path='e:/data/eu/video/cuts/img_2401.avi',fps=30,length=10,width=480,height=270}
--vid = ffmpeg.Video{path='e:/data/eu/video/cuts/img_2401.avi',fps=30,length=180,width=640,height=360}



-- process input at multiple scales
scales = {1, 0.8} --{0.5, 0.4, 0.3} --, 0.24, 0.192, 0.15}
