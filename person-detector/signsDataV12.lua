...
if paths.filep('trainSgV12.t7') 
   and paths.filep('testSgV12.t7') then

   print(sys.COLORS.red ..  '==> loading previously generated dataset:')
   trainData = torch.load('trainSgV12.t7')
   testData = torch.load('testSgV12.t7')
   ...
   if paths.filep('trainSgV12.t7') then
      ...
      torch.save('trainSgV12.t7',trainData)
   ...
   if paths.filep('testSgV12.t7') then
      ...
      torch.save('testSgV12.t7',testData)
   end
end
